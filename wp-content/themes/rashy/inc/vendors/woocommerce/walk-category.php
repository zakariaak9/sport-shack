<?php
/**
 * Rashy_WC_Product_Cat_Dropdown_Walker class
 *
 * @extends 	Walker
 * @class 		Rashy_WC_Product_Cat_Dropdown_Walker
 * @version		1.6.4
...
if ( ! class_exists( 'Rashy_WC_Product_Cat_Dropdown_Walker', false ) ) :

class Rashy_WC_Product_Cat_Dropdown_Walker extends Walker {
