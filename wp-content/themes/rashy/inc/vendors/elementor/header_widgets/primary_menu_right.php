...
class Rashy_Elementor_Primary_Menu_Right extends Elementor\Widget_Base {

	public function get_name() {
        return 'rashy_primary_menu_right';
    }

	public function get_title() {
        return esc_html__( 'Goal Header Primary Menu Right', 'rashy' );
    }
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Rashy_Elementor_Primary_Menu_Right );