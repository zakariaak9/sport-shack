...
class Rashy_Recent_Post extends Goal_Widget {
    public function __construct() {
        parent::__construct(
            'goal_recent_post',
            esc_html__('Goal Recent Posts Widget', 'rashy'),
            array( 'description' => esc_html__( 'Show list of recent post', 'rashy' ), )
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'rashy' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                <?php echo esc_html__('Type:', 'rashy' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'rashy' ); ?></label>
...
if ( function_exists('goal_framework_reg_widget') ) {
    goal_framework_reg_widget('Rashy_Recent_Post');
}