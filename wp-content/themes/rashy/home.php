...
<?php } ?>
<section id="main-container" class="main-content home-page-default archive-blog <?php echo apply_filters('rashy_blog_content_class', 'container');?> inner">
	<?php rashy_before_content( $sidebar_configs ); ?>
	<div class="row">
		<?php rashy_display_sidebar_left( $sidebar_configs ); ?>

		<div id="main-content" class="col-sm-12 <?php echo esc_attr($sidebar_configs['main']['class']); ?>">
			<div id="main" class="site-main <?php echo esc_attr($check); ?>" role="main">
			<?php if ( have_posts() ) : ?>
